...
# This script is hosted at https://github.com/GJKB/alis. For new features,
...
# Usage:
# # loadkeys es
# # curl https://raw.githubusercontent.com/GJKB/alis/master/download.sh | bash, or with URL shortener curl -sL https://bit.ly/2F3CATp | bash
# # vim alis.conf
# # ./alis.sh
